    ...
    return (
      <div
        ...
        <div className='landing-page-title'>
          <h1>
            Music-Tree is an Ad free youtube player.<br></br> It uses sever-side
            rendering and a custom DNS to stop them.{' '}
          </h1>
        </div>
        <div className='searchbar-wrapper'>
          <h2>
            Please sign up to get access to custom themes, avatars, the ability
            to like and add videos to a playlist, and more! <br></br>Get Started
